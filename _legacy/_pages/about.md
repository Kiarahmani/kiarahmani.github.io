...
permalink: /
title: "Kia Rahmani"
excerpt: "LLM systems, neurosymbolic program inference, and reliable AI infrastructure."
author_profile: true
redirect_from: 
  - /about/
  - /about.html
...
I’m part of the [Durable](https://durable.ai/) team, where we work on reliable agent/program synthesis from product requirement documents, multi-API integration, and automated QA/repair pipelines for LLM agents.
...
- **Programmatic Imitation Learning from Unlabeled and Noisy Demonstrations**  
  ...
  *IEEE RA-L*  
  [pdf](https://ieeexplore.ieee.org/document/10493855) · [Project](https://amrl.cs.utexas.edu/plunder) · [Video](https://youtu.be/Fy1P_46c54A?si=Ji5lmdo3lg6G1H4N)
...
- **Multi-modal Program Inference: a Marriage of Large Language Models and Component-based Synthesis**  
  ...
  *OOPSLA 2021*  
  [pdf](https://dl.acm.org/doi/10.1145/3485535)

- **Repairing Serializability Bugs in Distributed Database Programs via Automated Schema Refactoring**  
  **K. Rahmani**, K. Nagar, B. Delaware, S. Jagannathan  
  *PLDI 2021*  
  [pdf](https://dl.acm.org/doi/10.1145/3453483.3454028)

- **CLOTHO: Directed Test Generation for Weakly Consistent Database Systems**  
  **K. Rahmani**, K. Nagar, B. Delaware, S. Jagannathan  
  *OOPSLA 2019*  
  [pdf](https://arxiv.org/pdf/1908.05655.pdf)

- **Multi-modal Program Inference (US20230176829A1)**  
  **K. Rahmani**, M. Raza, S. Gulwani, V. Le, D. Morris, A. Radhakrishna, G. Soares, A. Tiwari  
  *US Patent Application*  
  [Patent](https://patentimages.storage.googleapis.com/0b/de/89/271010060d2ed8/US20230176829A1.pdf)

- **Symbolic Analysis of Weak Concurrency Semantics in Modern Database Programs**  
  **K. Rahmani**  
  *PhD Thesis, Purdue University, 2022*  
  [Thesis](https://doi.org/10.25394/PGS.20398725.v1)
